...
async def create_formation(formation: FormationCreate, db: AsyncSession = Depends(get_db)):
...
async def get_formations(skip: int = 0, limit: int = 100, db: AsyncSession = Depends(get_db)):
    """Get all formations."""
...
async def get_formation(formation_id: int, db: AsyncSession = Depends(get_db)):
...
async def delete_formation(formation_id: int, db: AsyncSession = Depends(get_db)):
    """Delete a formation."""
