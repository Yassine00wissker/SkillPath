...
from app.core.security import get_current_user, get_current_content_creator
...
async def create_job(
    ...
    """Create a new job (Content creator or Admin only)."""
...
async def get_job(
    ...
    """Get a job by ID (Authenticated users only)."""
...
async def update_job(
    ...
    """Update a job (Content creator or Admin only)."""
...
async def delete_job(
    ...
    """Delete a job (Content creator or Admin only)."""
